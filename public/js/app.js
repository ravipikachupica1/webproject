...
var addToCartdes = document.querySelectorAll('.add-to-cart-dessert');
var addToCartcur = document.querySelectorAll('.add-to-cart-course');
var addToCartstr = document.querySelectorAll('.add-to-cart-starter');
var addToCartktr = document.querySelectorAll('.add-to-cart-keventer');
...
addToCartdes.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var item = JSON.parse(btn.dataset.dessert);
    updateCart(item);
  });
});
addToCartcur.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var item = JSON.parse(btn.dataset.course);
    updateCart(item);
  });
});
addToCartstr.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var item = JSON.parse(btn.dataset.starter);
    updateCart(item);
  });
});
addToCartktr.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var item = JSON.parse(btn.dataset.keventer);
    updateCart(item);
  });
...
__webpack_require__(/*! C:\Users\MY pc\Backend\foodapp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\MY pc\Backend\foodapp\resources\scss\app.scss */"./resources/scss/app.scss");
